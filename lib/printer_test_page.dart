                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: (){
                                ...
                                PrintModel f = PrintModel(
                                  code: 'print',
                                  printMeta: PrintMeta(
                                    printMethod: 'PrintAndCut',
                                    ...
                                    printData: [
                                      PrintDatum(
                                        ...
                                        body: Body(
                                          bodyRows: [
                                            BodyRow(bodyColumns: [
                                              BodyColumn(text: 'USD', align: 'left', bold: false),
                                              BodyColumn(text: '100\$', align: 'right', bold: false),
                                            ]),
                                            BodyRow(bodyColumns: [
                                              BodyColumn(text: 'KHR', align: 'left', bold: false),
                                              BodyColumn(text: '40000R', align: 'right', bold: false),
                                            ]),
                                          ],
                                        ),
                                      ),
                                ...
                                widget.channel.sink.add(f.toJson());
                                ...
                                //     'printMethod': 'Print',
                                //     'templateName': 'CashDrawer',
                                //     'printModel': json.encode({
                                //       'date': '4/21/2022 10:59:13 AM',
                                //       'prices': json.encode([
                                //         json.encode(
                                //           {
                                //             'currency': 'KHR',
